...
CREATE TABLE Klient (
    ...
    Numer_Dowodu varchar(20)  NOT NULL,
    Seria_Dowodu varchar(20)  NOT NULL,
...
CREATE TABLE Pracownik (
    ...
    Pensja decimal(10,1)  NOT NULL,
    Typ_Umowy_ID_Typu integer  NOT NULL,
    ID_Szefa integer,
    CONSTRAINT Pracownik_ak_1 CHECK (ID_Szefa > 0),
...
CREATE TABLE Rzecz_Na_Sprzedaz (
    ...
    Cena_Sprzedazy decimal(5,1)  NOT NULL,
...
CREATE TABLE Typ_Umowy (
    ...
    Nazwa_Typu_Umowy varchar(30)  NOT NULL,
...
CREATE TABLE Umowa_Kupna_Sprzedazy (
    ...
    Kwota_Umowy decimal(5,1)  NOT NULL,
    Kwota_Podatku decimal(5,1),
    Upowaznienie_Imie varchar(20),
    Upowaznienie_Nazwisko varchar(30),
